...
import { BarChart3, TrendingUp, Receipt, Users, PiggyBank, FileText, Settings, Search, FolderOpen, Upload, Clock } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const mainNavigation = [
  ...
  { name: "Time Tracker", href: "/time-report", icon: Clock },
